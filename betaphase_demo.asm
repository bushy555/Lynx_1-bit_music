...
skipUpdate1			;***ch2***
	...
	ld (mix2),a	
	jr nc,_skipPhaseResetA	;phase reset yes/no
...
_noDutyMod2
	...
	ld a,h
	or l
	jr nz,skipPhaseB	;disable output on rests
...
tap_e:
;	display /d,end-begin
	savebin "betaphase_demo.tap",tap_b,tap_e-tap_b
