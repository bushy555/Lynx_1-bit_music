...
;  Working!!     Night Dancer on the Camputers Lynx computer. 
; This assembles to a Lynx .TAP file.
;  Use "Jynx" Lynx emulator.  Auto loads within the Jynx emulator.
;
; camputers Lynx (beeper)
; ========================
; origin	$6500
; bit 4 port $0084
; bit 7 must be 0
...
; +--------------------------------------------------+
; |                                                  |
; |  Player : OCTODE XL	by Shiru.                    |
; |  Song   : NIGHT DANCER by Mr Beep                |
; |                                                  |
; +--------------------------------------------------+
;
;
; USE SJASM assembler.
; Assemble by :		sjasmplus <file>.asm
; * Dont forget to copy and edit the footer where the filename is stored.
;
;
;
;	ORG	$8000		; ZX speccy
...
;	display /d,end-begin
	...
	savebin "dance.tap",tap_b,tap_e-tap_b
