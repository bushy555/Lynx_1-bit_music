...
; Compo: Beeper Music
; Duration (minutes): 2:49
; P.S.: ???????????? ?????????? ??? — ?? ??????.
;
; Written for DieHard 2023 compo.
;
;
; -------------------------------------------------
; Assemble :       sjasmplus %1.asm
; Assembles straight to a .VZ snapshot.
; -------------------------------------------------
;
...
;	display /d,end-begin
	...
	savebin "strangegame.tap",tap_b,tap_e-tap_b
